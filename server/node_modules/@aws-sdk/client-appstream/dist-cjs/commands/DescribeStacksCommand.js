...
class DescribeStacksCommand extends smithy_client_1.Command {
    ...
    resolveMiddleware(clientStack, configuration, options) {
        ...
        const handlerExecutionContext = {
            ...
            clientName,
            commandName,
            inputFilterSensitiveLog: models_0_1.DescribeStacksRequest.filterSensitiveLog,
            outputFilterSensitiveLog: models_0_1.DescribeStacksResult.filterSensitiveLog,
        };
